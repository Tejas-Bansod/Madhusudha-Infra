...
## Corpus Check
- 81 files · ~18,997 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 555 nodes · 946 edges · 53 communities (36 shown, 17 thin omitted)
...
Cohesion: 0.14
Nodes (8): HoverCardContent(), Pagination(), PaginationContent(), PaginationEllipsis(), PaginationLink(), PaginationLinkProps, PaginationNext(), PaginationPrevious()

### Community 7 - "Tailwind Theme Configurations"
Cohesion: 0.10
Nodes (22): cn(), Accordion(), AccordionContent(), AccordionItem(), AccordionTrigger(), Checkbox(), RadioGroup(), RadioGroupItem() (+14 more)
...
Cohesion: 0.13
Nodes (15): columns, TaskBoard(), TaskCard(), mockTasks, Task, TaskPriority, TaskStatus, TaskType (+7 more)
...
- **Why does `cn()` connect `Tailwind Theme Configurations` to `UI Components and Utilities`, `Development Build Dependencies`, `Project Metadata and Scripts`, `Path Import Aliases`, `Community 19`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 35`, `Community 51`, `Community 52`?**
  _High betweenness centrality (0.362) - this node is a cross-community bridge._
- **Why does `Button()` connect `Development Build Dependencies` to `Community 35`, `Project Metadata and Scripts`, `Path Import Aliases`, `Tailwind Theme Configurations`, `Community 19`, `Community 21`, `Community 23`, `Community 26`?**
