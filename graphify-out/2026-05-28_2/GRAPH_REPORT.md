...
## Corpus Check
- 140 files · ~61,976 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 906 nodes · 2050 edges · 67 communities (44 shown, 23 thin omitted)
...
Cohesion: 0.05
Nodes (58): Attachment, SUGGESTIONS, TEMPLATES, EmailLogTableProps, EmailStatus, STATUS_META, FileUploadModal(), InvoiceList() (+50 more)

### Community 7 - "Tailwind Theme Configurations"
Cohesion: 0.05
Nodes (54): AgentCard(), AgentCardProps, DocumentStats(), EmailComposer(), EmailLogEntry, EmailLogTable(), DEFAULT_EMAIL_STATS, EmailStats() (+46 more)
...
Cohesion: 0.15
Nodes (15): Column(), columns, dropAnimation, measuring, SortableTask(), TaskBoard(), TaskCard(), TaskTable() (+7 more)
...
Cohesion: 0.07
Nodes (35): AgentsPage(), cn(), PropertyListingsPage(), StatCard(), TemplatesPage(), Accordion(), AccordionContent(), AccordionItem() (+27 more)
...
Cohesion: 0.14
Nodes (22): DocumentGrid(), DocumentGridProps, FileItem, DocumentList(), DocumentListProps, FileItem, invoices, priorityColorMap (+14 more)

### Community 30 - "Community 30"
Cohesion: 0.09
Nodes (27): dropAnimation, KanbanColumn(), LeadCard(), LeadKanban, LeadKanbanProps, LeadKanbanRef, measuring, priorityConfig (+19 more)
...
Cohesion: 0.07
Nodes (18): AgentDetailsSheet(), AgentDetailsSheetProps, NavItem, navItems, SocialIcons, NotificationsDropdown(), TopbarProps, Sheet() (+10 more)
...
Cohesion: 0.25
Nodes (12): AgentLeaderboard(), AgentLeaderboardProps, ListingTable(), ListingTableProps, Table(), TableBody(), TableCaption(), TableCell() (+4 more)
