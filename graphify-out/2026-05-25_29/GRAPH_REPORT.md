...
## Corpus Check
- 89 files · ~27,854 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 597 nodes · 1141 edges · 53 communities (35 shown, 18 thin omitted)
...
Cohesion: 0.06
Nodes (50): Column(), columns, dropAnimation, measuring, SortableTask(), TaskBoard(), priorityColorMap, TaskCard() (+42 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (19): Button(), buttonVariants, Calendar(), CalendarDayButton(), InputGroupAddon(), inputGroupAddonVariants, InputGroupButton(), inputGroupButtonVariants (+11 more)
...
Cohesion: 0.13
Nodes (23): cn(), Breadcrumb(), BreadcrumbEllipsis(), BreadcrumbItem(), BreadcrumbLink(), BreadcrumbList(), BreadcrumbPage(), BreadcrumbSeparator() (+15 more)
...
Cohesion: 0.11
Nodes (8): Checkbox(), HoverCardContent(), RadioGroup(), RadioGroupItem(), Separator(), Skeleton(), Slider(), Switch()
...
Cohesion: 0.05
Nodes (52): dropAnimation, KanbanColumn(), LeadCard(), LeadKanban(), measuring, priorityConfig, SortableLead(), LeadTable() (+44 more)
...
- **Why does `Button()` connect `Community 6` to `Development Build Dependencies`, `Project Metadata and Scripts`, `Community 21`, `Community 23`, `Community 26`, `Community 30`?**
