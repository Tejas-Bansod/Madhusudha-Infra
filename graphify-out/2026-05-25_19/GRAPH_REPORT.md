...
## Corpus Check
- 82 files · ~20,418 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 560 nodes · 991 edges · 51 communities (33 shown, 18 thin omitted)
...
Cohesion: 0.09
Nodes (20): AlertDialogAction(), AlertDialogCancel(), AlertDialogContent(), AlertDialogDescription(), AlertDialogFooter(), AlertDialogHeader(), AlertDialogMedia(), AlertDialogOverlay() (+12 more)

### Community 5 - "Project Metadata and Scripts"
Cohesion: 0.09
Nodes (32): priorityColorMap, typeColorMap, typeIconMap, TaskTable(), featuredListings, overviewData, recentLeads, revenueData (+24 more)
...
Cohesion: 0.08
Nodes (28): appsItems, Sidebar(), SidebarProps, upperNavItems, TopbarProps, DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent() (+20 more)
...
Cohesion: 0.06
Nodes (31): Column(), columns, TaskBoard(), TaskCard(), Theme, ThemeContext, ThemeContextType, ThemeProvider() (+23 more)
...
## Knowledge Gaps
- **155 isolated node(s):** `name`, `version`, `private`, `dev`, `build` (+150 more)
...
- **Why does `cn()` connect `Community 32` to `Community 33`, `UI Components and Utilities`, `Community 35`, `Development Build Dependencies`, `Project Metadata and Scripts`, `Community 6`, `Tailwind Theme Configurations`, `Community 19`, `Community 51`, `Community 21`, `Community 52`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.364) - this node is a cross-community bridge._
- **Why does `Button()` connect `Development Build Dependencies` to `Community 32`, `Community 35`, `Project Metadata and Scripts`, `Community 21`, `Community 23`, `Community 26`, `Community 30`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `useTheme()` connect `Community 35` to `Community 30`?**
