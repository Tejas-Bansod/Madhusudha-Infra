...
## Corpus Check
- 89 files · ~27,890 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 597 nodes · 1143 edges · 57 communities (39 shown, 18 thin omitted)
...
5. `Badge()` - 10 edges
6. `DropdownMenuContent()` - 10 edges
7. `DropdownMenu()` - 9 edges
8. `DropdownMenuTrigger()` - 9 edges
9. `DropdownMenuItem()` - 9 edges
10. `Input()` - 8 edges
...
Cohesion: 0.12
Nodes (18): priorityColorMap, TaskCard(), typeColorMap, typeIconMap, featuredListings, overviewData, recentLeads, revenueData (+10 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (31): Column(), columns, dropAnimation, measuring, SortableTask(), TaskBoard(), mockTasks, Task (+23 more)
...
Cohesion: 0.12
Nodes (25): cn(), Breadcrumb(), BreadcrumbEllipsis(), BreadcrumbItem(), BreadcrumbLink(), BreadcrumbList(), BreadcrumbPage(), BreadcrumbSeparator() (+17 more)
...
Cohesion: 0.10
Nodes (10): Checkbox(), InputOTP(), InputOTPGroup(), InputOTPSlot(), ResizableHandle(), ResizablePanelGroup(), Separator(), Skeleton() (+2 more)
...
Cohesion: 0.11
Nodes (18): NotificationsDropdown(), Theme, ThemeContext, ThemeContextType, ThemeProvider(), useTheme(), Topbar(), TopbarProps (+10 more)

### Community 30 - "Community 30"
Cohesion: 0.14
Nodes (16): LeadKanban(), LeadTable(), priorityConfig, SortDir, SortField, StageBadge(), Lead, LEAD_STAGES (+8 more)
...
Cohesion: 0.15
Nodes (13): dropAnimation, KanbanColumn(), LeadCard(), measuring, priorityConfig, SortableLead(), Avatar(), AvatarBadge() (+5 more)

### Community 52 - "Community 52"
Cohesion: 0.18
Nodes (9): DropdownMenu(), DropdownMenuContent(), DropdownMenuLabel(), DropdownMenuRadioItem(), DropdownMenuSeparator(), DropdownMenuShortcut(), DropdownMenuSubContent(), DropdownMenuSubTrigger() (+1 more)

### Community 53 - "Community 53"
Cohesion: 0.29
Nodes (9): TaskTable(), Table(), TableBody(), TableCaption(), TableCell(), TableFooter(), TableHead(), TableHeader() (+1 more)
