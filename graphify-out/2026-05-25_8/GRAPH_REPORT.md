...
## Corpus Check
- 78 files · ~17,779 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 541 nodes · 891 edges · 52 communities (35 shown, 17 thin omitted)
...
- `Sidebar()` --calls--> `cn()`  [EXTRACTED]
  crm/src/app/dashboard/components/sidebar.tsx → crm/src/lib/utils.ts
...
Cohesion: 0.05
Nodes (42): appsItems, Sidebar(), SidebarProps, upperNavItems, Theme, ThemeContext, ThemeContextType, ThemeProvider() (+34 more)

### Community 5 - "Project Metadata and Scripts"
Cohesion: 0.08
Nodes (27): featuredListings, overviewData, recentLeads, revenueData, Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup() (+19 more)

### Community 6 - "Path Import Aliases"
Cohesion: 0.06
Nodes (20): Checkbox(), HoverCardContent(), Pagination(), PaginationContent(), PaginationEllipsis(), PaginationLink(), PaginationLinkProps, PaginationNext() (+12 more)

### Community 7 - "Tailwind Theme Configurations"
Cohesion: 0.15
Nodes (18): cn(), Accordion(), AccordionContent(), AccordionItem(), AccordionTrigger(), InputOTP(), InputOTPGroup(), InputOTPSlot() (+10 more)
...
## Knowledge Gaps
- **152 isolated node(s):** `name`, `version`, `private`, `dev`, `build` (+147 more)
...
- **Why does `cn()` connect `Tailwind Theme Configurations` to `Community 32`, `Community 33`, `UI Components and Utilities`, `Development Build Dependencies`, `Project Metadata and Scripts`, `Path Import Aliases`, `Community 19`, `Community 52`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.356) - this node is a cross-community bridge._
- **Why does `Button()` connect `Development Build Dependencies` to `Project Metadata and Scripts`, `Path Import Aliases`, `Tailwind Theme Configurations`, `Community 19`, `Community 21`, `Community 23`, `Community 26`, `Community 30`?**
