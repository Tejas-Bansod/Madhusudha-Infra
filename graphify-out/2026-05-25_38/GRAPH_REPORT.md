...
## Corpus Check
- 103 files · ~41,336 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 656 nodes · 1446 edges · 53 communities (36 shown, 17 thin omitted)
...
6. `Avatar()` - 14 edges
7. `AvatarImage()` - 14 edges
8. `AvatarFallback()` - 14 edges
9. `Input()` - 12 edges
...
Cohesion: 0.10
Nodes (39): AgentDetailsSheetProps, AgentLeaderboardProps, ListingCard(), ListingCardProps, ListingDetailsDrawer(), ListingDetailsDrawerProps, ListingTable(), ListingTableProps (+31 more)

### Community 6 - "Community 6"
Cohesion: 0.08
Nodes (27): AgentCardProps, priorityColorMap, typeColorMap, typeIconMap, featuredListings, overviewData, recentLeads, revenueData (+19 more)
...
Cohesion: 0.15
Nodes (16): AgentsPage(), AgentCard(), AgentDetailsSheet(), AgentLeaderboard(), Agent, mockAgents, Select(), SelectContent() (+8 more)
...
Cohesion: 0.07
Nodes (27): ListingMapHud(), ListingMapHudProps, Column(), columns, dropAnimation, measuring, SortableTask(), TaskBoard() (+19 more)
...
Cohesion: 0.11
Nodes (21): cn(), Accordion(), AccordionContent(), AccordionItem(), AccordionTrigger(), Breadcrumb(), BreadcrumbEllipsis(), BreadcrumbItem() (+13 more)
...
Cohesion: 0.07
Nodes (44): dropAnimation, KanbanColumn(), LeadCard(), LeadKanban, LeadKanbanProps, LeadKanbanRef, measuring, priorityConfig (+36 more)
...
- **Why does `cn()` connect `Community 27` to `UI Components and Utilities`, `Development Build Dependencies`, `Project Metadata and Scripts`, `Community 6`, `Tailwind Theme Configurations`, `Community 19`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 35`, `Community 37`, `Community 55`?**
  _High betweenness centrality (0.392) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 6` to `Community 35`, `Project Metadata and Scripts`, `Community 37`, `Community 19`, `Community 23`, `Community 21`, `Community 55`, `Community 26`, `Community 27`, `Community 29`?**
