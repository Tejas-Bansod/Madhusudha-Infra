...
## Corpus Check
- 141 files · ~62,827 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 909 nodes · 2053 edges · 67 communities (44 shown, 23 thin omitted)
...
Cohesion: 0.07
Nodes (50): AgentsPage(), AgentCard(), AgentDetailsSheet(), AgentLeaderboard(), Attachment, SUGGESTIONS, TEMPLATES, EmailLogTableProps (+42 more)
...
Cohesion: 0.05
Nodes (57): AgentCardProps, DocumentStats(), EmailComposer(), EmailLogEntry, EmailLogTable(), DEFAULT_EMAIL_STATS, EmailStats(), EmailStatsProps (+49 more)
...
Cohesion: 0.07
Nodes (44): AgentLeaderboardProps, ListingTable(), ListingTableProps, Column(), columns, dropAnimation, measuring, SortableTask() (+36 more)
...
Cohesion: 0.07
Nodes (34): ListingCard(), ListingDetailsDrawer(), cn(), PropertyListingsPage(), StatCard(), TemplatesPage(), Accordion(), AccordionContent() (+26 more)
...
Cohesion: 0.15
Nodes (14): DocumentGrid(), DocumentGridProps, FileItem, DocumentList(), DocumentListProps, FileItem, NotificationsDropdown(), TopbarProps (+6 more)
...
Cohesion: 0.06
Nodes (24): AgentDetailsSheetProps, NavItem, navItems, SocialIcons, ScheduleVisitModal(), VisitCalendar(), VisitList(), VisitStats() (+16 more)
