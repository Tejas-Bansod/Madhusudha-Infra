...
## Corpus Check
- 82 files · ~20,622 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 563 nodes · 996 edges · 49 communities (32 shown, 17 thin omitted)
...
Cohesion: 0.09
Nodes (24): Button(), buttonVariants, Calendar(), CalendarDayButton(), Carousel(), CarouselApi, CarouselContent(), CarouselContext (+16 more)
...
- **Why does `Button()` connect `Community 26` to `Development Build Dependencies`, `Project Metadata and Scripts`, `Community 6`, `Community 21`, `Community 23`, `Community 30`?**
