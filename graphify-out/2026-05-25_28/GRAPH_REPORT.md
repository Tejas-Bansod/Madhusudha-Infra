...
## Corpus Check
- 85 files · ~23,525 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 570 nodes · 1024 edges · 53 communities (35 shown, 18 thin omitted)
...
Cohesion: 0.08
Nodes (33): priorityColorMap, typeColorMap, typeIconMap, TaskTable(), featuredListings, overviewData, recentLeads, revenueData (+25 more)

### Community 6 - "Community 6"
Cohesion: 0.08
Nodes (24): Column(), columns, dropAnimation, measuring, SortableTask(), TaskBoard(), TaskCard(), mockTasks (+16 more)
...
Cohesion: 0.06
Nodes (39): NotificationsDropdown(), appsItems, Sidebar(), SidebarProps, upperNavItems, Theme, ThemeContext, ThemeContextType (+31 more)
