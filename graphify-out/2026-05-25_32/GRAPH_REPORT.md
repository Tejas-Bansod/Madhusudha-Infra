...
## Corpus Check
- 91 files · ~31,783 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 617 nodes · 1218 edges · 51 communities (33 shown, 18 thin omitted)
...
5. `Badge()` - 11 edges
6. `DropdownMenuContent()` - 11 edges
7. `DropdownMenu()` - 10 edges
8. `DropdownMenuTrigger()` - 10 edges
9. `Input()` - 9 edges
10. `ScrollArea()` - 9 edges
...
Cohesion: 0.09
Nodes (32): Column(), columns, dropAnimation, measuring, SortableTask(), TaskBoard(), priorityColorMap, TaskCard() (+24 more)

### Community 6 - "Community 6"
Cohesion: 0.11
Nodes (18): featuredListings, overviewData, recentLeads, revenueData, Card(), CardAction(), CardContent(), CardDescription() (+10 more)
...
Cohesion: 0.07
Nodes (43): dropAnimation, KanbanColumn(), LeadCard(), LeadKanban, LeadKanbanProps, LeadKanbanRef, measuring, priorityConfig (+35 more)
...
Cohesion: 0.07
Nodes (20): Theme, ThemeContext, ThemeContextType, ThemeProvider(), useTheme(), Topbar(), DashboardContent(), Checkbox() (+12 more)
...
Cohesion: 0.08
Nodes (29): NotificationsDropdown(), TopbarProps, CustomerCard(), CustomerDrawer(), CustomersPage(), getProgressColor(), getProgressPercentage(), StatCard() (+21 more)
...
Cohesion: 0.11
Nodes (25): cn(), Accordion(), AccordionContent(), AccordionItem(), AccordionTrigger(), Breadcrumb(), BreadcrumbEllipsis(), BreadcrumbItem() (+17 more)
