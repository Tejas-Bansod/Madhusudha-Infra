...
## Corpus Check
- 103 files · ~42,130 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 663 nodes · 1496 edges · 52 communities (35 shown, 17 thin omitted)
...
6. `Avatar()` - 16 edges
7. `AvatarImage()` - 16 edges
8. `AvatarFallback()` - 16 edges
9. `useTheme()` - 12 edges
10. `Input()` - 12 edges
...
Cohesion: 0.11
Nodes (23): AgentDetailsSheetProps, ListingCard(), ListingDetailsDrawer(), ListingDetailsDrawerProps, ListingMapHud(), ListingMapHudProps, ListingTable(), LISTING_STATUSES (+15 more)

### Community 6 - "Community 6"
Cohesion: 0.10
Nodes (42): AgentCard(), AgentCardProps, AgentLeaderboardProps, priorityConfig, SortDir, SortField, ListingCardProps, ListingTableProps (+34 more)

### Community 7 - "Tailwind Theme Configurations"
Cohesion: 0.15
Nodes (10): featuredListings, overviewData, recentLeads, revenueData, Progress(), Tabs(), TabsContent(), TabsList() (+2 more)
...
Cohesion: 0.18
Nodes (13): AgentsPage(), AgentDetailsSheet(), AgentLeaderboard(), Select(), SelectContent(), SelectGroup(), SelectItem(), SelectLabel() (+5 more)
...
Cohesion: 0.07
Nodes (27): AlertDialogAction(), AlertDialogCancel(), AlertDialogContent(), AlertDialogDescription(), AlertDialogFooter(), AlertDialogHeader(), AlertDialogMedia(), AlertDialogOverlay() (+19 more)

### Community 27 - "Community 27"
Cohesion: 0.09
Nodes (23): StageBadge(), cn(), Accordion(), AccordionContent(), AccordionItem(), AccordionTrigger(), AvatarBadge(), AvatarGroup() (+15 more)
...
Cohesion: 0.06
Nodes (39): dropAnimation, KanbanColumn(), LeadCard(), LeadKanban, LeadKanbanProps, LeadKanbanRef, measuring, priorityConfig (+31 more)
...
Cohesion: 0.08
Nodes (30): CustomerCard(), CustomerDrawer(), CustomersPage(), getProgressColor(), getProgressPercentage(), StatCard(), Customer, CUSTOMER_STATUSES (+22 more)
...
## Knowledge Gaps
- **178 isolated node(s):** `name`, `version`, `private`, `dev`, `build` (+173 more)
...
- **Why does `Button()` connect `Community 26` to `Community 35`, `Project Metadata and Scripts`, `Community 6`, `Tailwind Theme Configurations`, `Community 37`, `Community 19`, `Community 21`, `Community 23`, `Community 27`, `Community 29`?**
