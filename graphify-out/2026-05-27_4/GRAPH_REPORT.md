...
## Corpus Check
- 125 files · ~57,823 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 749 nodes · 1888 edges · 56 communities (38 shown, 18 thin omitted)
...
Cohesion: 0.05
Nodes (43): dependencies, @base-ui/react, class-variance-authority, clsx, cmdk, date-fns, @dnd-kit/core, @dnd-kit/sortable (+35 more)
...
Cohesion: 0.10
Nodes (24): ListingDetailsDrawer(), ListingDetailsDrawerProps, CustomerCard(), CustomerDrawer(), CustomersPage(), getProgressColor(), getProgressPercentage(), StatCard() (+16 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (36): AgentCardProps, EmailLogEntry, EmailLogTable(), DEFAULT_EMAIL_STATS, EmailStats(), EmailStatsProps, Stat, mockEvents (+28 more)

### Community 7 - "Tailwind Theme Configurations"
Cohesion: 0.09
Nodes (28): ListingCard(), ListingCardProps, ListingMapHud(), ListingMapHudProps, ListingTable(), ListingTableProps, COMMON_AMENITIES, PropertyForm() (+20 more)
...
Cohesion: 0.08
Nodes (26): AgentDetailsSheetProps, ScheduleVisitModal(), Column(), columns, dropAnimation, measuring, SortableTask(), TaskBoard() (+18 more)
...
Cohesion: 0.09
Nodes (26): cn(), Accordion(), AccordionContent(), AccordionItem(), AccordionTrigger(), AvatarBadge(), AvatarGroup(), AvatarGroupCount() (+18 more)
...
Cohesion: 0.11
Nodes (18): DocumentGrid(), DocumentGridProps, FileItem, DocumentListProps, FileItem, invoices, NotificationsDropdown(), TopbarProps (+10 more)
...
Cohesion: 0.06
Nodes (52): AgentsPage(), AgentCard(), AgentDetailsSheet(), AgentLeaderboard(), DocumentList(), DocumentStats(), Attachment, EmailComposer() (+44 more)
...
Cohesion: 0.25
Nodes (12): AgentLeaderboardProps, priorityColorMap, typeColorMap, typeIconMap, Table(), TableBody(), TableCaption(), TableCell() (+4 more)
...
Cohesion: 0.29
Nodes (6): InvoiceList(), InvoiceStats(), Button(), buttonVariants, Calendar(), CalendarDayButton()

## Knowledge Gaps
- **210 isolated node(s):** `name`, `version`, `private`, `dev`, `build` (+205 more)
...
- **Why does `Button()` connect `Community 55` to `Community 35`, `Project Metadata and Scripts`, `Community 6`, `Tailwind Theme Configurations`, `Community 37`, `Community 51`, `Community 52`, `Community 21`, `Community 19`, `Community 23`, `Community 26`, `Community 27`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Badge()` connect `Community 6` to `Community 35`, `Project Metadata and Scripts`, `Tailwind Theme Configurations`, `Community 51`, `Community 52`, `Community 21`, `Community 27`, `Community 29`, `Community 30`?**
