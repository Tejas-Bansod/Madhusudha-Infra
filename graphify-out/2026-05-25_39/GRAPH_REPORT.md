...
## Corpus Check
- 103 files · ~42,129 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 659 nodes · 1471 edges · 51 communities (34 shown, 17 thin omitted)
...
6. `Avatar()` - 15 edges
7. `AvatarImage()` - 15 edges
8. `AvatarFallback()` - 15 edges
9. `Input()` - 12 edges
10. `DropdownMenuContent()` - 12 edges
...
Cohesion: 0.06
Nodes (40): AgentDetailsSheetProps, ListingCard(), ListingCardProps, ListingDetailsDrawer(), ListingDetailsDrawerProps, ListingMapHud(), ListingMapHudProps, ListingTable() (+32 more)

### Community 6 - "Community 6"
Cohesion: 0.11
Nodes (40): AgentCardProps, AgentLeaderboardProps, priorityConfig, SortDir, SortField, ListingTableProps, priorityColorMap, typeColorMap (+32 more)
...
Cohesion: 0.17
Nodes (14): AgentsPage(), AgentCard(), AgentDetailsSheet(), AgentLeaderboard(), Select(), SelectContent(), SelectGroup(), SelectItem() (+6 more)
...
Cohesion: 0.08
Nodes (25): appsItems, Sidebar(), SidebarProps, upperNavItems, Column(), columns, dropAnimation, measuring (+17 more)
...
Cohesion: 0.08
Nodes (31): StageBadge(), cn(), Accordion(), AccordionContent(), AccordionItem(), AccordionTrigger(), AvatarBadge(), AvatarGroup() (+23 more)
...
Cohesion: 0.08
Nodes (25): dropAnimation, KanbanColumn(), LeadCard(), LeadKanban, LeadKanbanProps, LeadKanbanRef, measuring, priorityConfig (+17 more)
...
## Knowledge Gaps
- **176 isolated node(s):** `name`, `version`, `private`, `dev`, `build` (+171 more)
...
- **Why does `cn()` connect `Community 27` to `UI Components and Utilities`, `Development Build Dependencies`, `Project Metadata and Scripts`, `Community 6`, `Tailwind Theme Configurations`, `Community 19`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 35`, `Community 37`?**
  _High betweenness centrality (0.393) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 6` to `UI Components and Utilities`, `Community 35`, `Project Metadata and Scripts`, `Community 37`, `Community 19`, `Community 21`, `Community 23`, `Community 26`, `Community 27`, `Community 29`?**
