...
## Corpus Check
- 97 files · ~37,752 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 641 nodes · 1349 edges · 51 communities (34 shown, 17 thin omitted)
...
Cohesion: 0.07
Nodes (50): dropAnimation, KanbanColumn(), LeadCard(), LeadKanban, LeadKanbanProps, LeadKanbanRef, measuring, priorityConfig (+42 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (34): Column(), columns, dropAnimation, measuring, SortableTask(), TaskBoard(), priorityColorMap, TaskCard() (+26 more)
...
Cohesion: 0.17
Nodes (10): ListingMapHud(), ListingMapHudProps, Theme, ThemeContext, ThemeContextType, ThemeProvider(), useTheme(), Topbar() (+2 more)
...
Cohesion: 0.09
Nodes (10): Checkbox(), HoverCardContent(), RadioGroup(), RadioGroupItem(), ResizableHandle(), ResizablePanelGroup(), Separator(), Skeleton() (+2 more)
...
Cohesion: 0.05
Nodes (57): ListingDetailsDrawer(), ListingDetailsDrawerProps, NotificationsDropdown(), appsItems, Sidebar(), SidebarProps, upperNavItems, TopbarProps (+49 more)
...
Cohesion: 0.10
Nodes (31): cn(), Accordion(), AccordionContent(), AccordionItem(), AccordionTrigger(), AlertDialogAction(), AlertDialogCancel(), AlertDialogContent() (+23 more)
...
- **Why does `Button()` connect `Community 29` to `UI Components and Utilities`, `Project Metadata and Scripts`, `Community 6`, `Community 37`, `Community 55`, `Community 23`, `Community 26`?**
