...
## Corpus Check
- 77 files · ~17,735 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 539 nodes · 886 edges · 54 communities (36 shown, 18 thin omitted)
...
Cohesion: 0.06
Nodes (36): appsItems, Sidebar(), SidebarProps, upperNavItems, Theme, ThemeContext, ThemeContextType, ThemeProvider() (+28 more)

### Community 5 - "Project Metadata and Scripts"
Cohesion: 0.08
Nodes (26): featuredListings, overviewData, recentLeads, revenueData, Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup() (+18 more)

### Community 6 - "Path Import Aliases"
Cohesion: 0.09
Nodes (13): Checkbox(), HoverCardContent(), ResizableHandle(), ResizablePanelGroup(), Separator(), Skeleton(), Slider(), Switch() (+5 more)
...
Cohesion: 0.15
Nodes (18): cn(), ComboboxChip(), ComboboxChips(), ComboboxChipsInput(), ComboboxClear(), ComboboxContent(), ComboboxEmpty(), ComboboxGroup() (+10 more)
...
- **Why does `Button()` connect `Community 19` to `Development Build Dependencies`, `Project Metadata and Scripts`, `Community 21`, `Community 23`, `Community 26`, `Community 30`?**
