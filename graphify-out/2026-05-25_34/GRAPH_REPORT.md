...
## Corpus Check
- 97 files · ~36,514 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 640 nodes · 1344 edges · 51 communities (34 shown, 17 thin omitted)
...
5. `Badge()` - 16 edges
6. `DropdownMenuContent()` - 12 edges
7. `Avatar()` - 11 edges
8. `AvatarImage()` - 11 edges
9. `AvatarFallback()` - 11 edges
10. `Input()` - 11 edges
...
Cohesion: 0.12
Nodes (30): ListingCard(), ListingCardProps, ListingMapHud(), ListingMapHudProps, ListingTable(), ListingTableProps, LISTING_STATUSES, ListingStatus (+22 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (36): Column(), columns, dropAnimation, measuring, SortableTask(), TaskBoard(), priorityColorMap, TaskCard() (+28 more)

### Community 7 - "Tailwind Theme Configurations"
Cohesion: 0.07
Nodes (33): dropAnimation, KanbanColumn(), LeadCard(), LeadKanban, LeadKanbanProps, LeadKanbanRef, measuring, priorityConfig (+25 more)
...
Cohesion: 0.07
Nodes (35): LeadTable(), priorityConfig, SortDir, SortField, StageBadge(), NotificationsDropdown(), appsItems, Sidebar() (+27 more)
...
Cohesion: 0.11
Nodes (8): Checkbox(), HoverCardContent(), ResizableHandle(), ResizablePanelGroup(), Separator(), Skeleton(), Slider(), Switch()
...
Cohesion: 0.08
Nodes (29): ListingDetailsDrawer(), ListingDetailsDrawerProps, CustomerCard(), CustomerDrawer(), CustomersPage(), getProgressColor(), getProgressPercentage(), StatCard() (+21 more)
...
Cohesion: 0.11
Nodes (26): cn(), Accordion(), AccordionContent(), AccordionItem(), AccordionTrigger(), Breadcrumb(), BreadcrumbEllipsis(), BreadcrumbItem() (+18 more)
...
## Knowledge Gaps
- **171 isolated node(s):** `name`, `version`, `private`, `dev`, `build` (+166 more)
...
- **Why does `cn()` connect `Community 37` to `UI Components and Utilities`, `Development Build Dependencies`, `Project Metadata and Scripts`, `Community 6`, `Tailwind Theme Configurations`, `Community 19`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 55`?**
  _High betweenness centrality (0.390) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 29` to `Development Build Dependencies`, `Project Metadata and Scripts`, `Community 6`, `Tailwind Theme Configurations`, `Community 37`, `Community 23`, `Community 21`, `Community 55`, `Community 26`?**
