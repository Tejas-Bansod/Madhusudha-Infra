...
## Corpus Check
- 77 files · ~17,727 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 539 nodes · 883 edges · 52 communities (35 shown, 17 thin omitted)
...
Cohesion: 0.14
Nodes (20): cn(), ComboboxChip(), ComboboxChips(), ComboboxChipsInput(), ComboboxClear(), ComboboxContent(), ComboboxEmpty(), ComboboxGroup() (+12 more)
