...
## Corpus Check
- 97 files · ~37,484 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 641 nodes · 1345 edges · 51 communities (34 shown, 17 thin omitted)
...
Cohesion: 0.06
Nodes (52): dropAnimation, KanbanColumn(), LeadCard(), LeadKanban, LeadKanbanProps, LeadKanbanRef, measuring, priorityConfig (+44 more)
...
Cohesion: 0.21
Nodes (8): Theme, ThemeContext, ThemeContextType, ThemeProvider(), useTheme(), Topbar(), DashboardContent(), Toaster()
